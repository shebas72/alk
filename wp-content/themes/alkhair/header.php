...
Disclosures
										...
										<!-- <button class="hamburguer-btn hamburguer-btn-light hamburguer-btn-sticky-dark" data-set-active="false" data-toggle="modal" data-target="#largeModal">
...
<!-- 
						...
						<!-- <nav role='navigation' class="hamburguer-btn hamburguer-btn-sticky-dark">
  <div id="menuToggle">
